...
window.__MODULES__.ui = (function() {
    ...
    function updateStatus(msg) {
        ...
        if (bar) {
            ...
            CONFIG.groups.forEach(function(g) {
                parts.push(g.label + ': ' + tagOps.getSelectedCount(g.id));
            });
            var tpl = templateManager.getCurrentTemplate();
    ...
    function toggleGroupType(groupId) {
        ...
        renderUI();
        updateButtons();
        showToast('🔄 已切换为 ' + (newType === 'radio' ? '单选' : '多选'));
    }
